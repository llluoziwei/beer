...
var _maskView,
      ...
      : void (_createLoading(-1),
        ...
        _downloadTask.onProgressUpdate(function (a) {
          _loadingProgress != a.progress &&
            ((_loadingProgress = a.progress), _createLoading(a.progress));
        }));
  },
  init = function (a) {
  ...
  close = function () {
    _downloadTask &&
      (_downloadTask.abort(), (_downloadTask = null), _createLoading(-2)),
